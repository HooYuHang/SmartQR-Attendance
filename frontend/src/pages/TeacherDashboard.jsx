...
const TeacherDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (userInfo) {
      ...
      setUserRole(userInfo.role || "Teacher");
      setLoading(false);
    } else {
      navigate("/"); // Redirect to home page if user info isn't found
    }
  }, [navigate]);
  ...
  const handleLogout = () => {
    ...
    setTimeout(() => {
      localStorage.clear();
      navigate("/"); // Redirect after 1.2 seconds
    }, 1200);
  };
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ fontSize: "40px", marginTop: "30px" }}>🍎 Teacher Dashboard</h1>
        ...
        >
          ...
          <a
            href="/teacher/dashboard/create-class"
            style={optionStyle}
            onMouseOver={(e) => handleHover(e, true)}
            onMouseOut={(e) => handleHover(e, false)}
          >
            <span>📚 Create subjects + classes</span> ➜
          </a>
          ...
          <a
            ...
            onMouseOut={(e) => handleHover(e, false)}
          >
            <span>📝 Manage your classes & enroll students</span> ➜
          </a>

          <a
            href="/teacher/dashboard/generate-qr"
            style={optionStyle}
            onMouseOver={(e) => handleHover(e, true)}
            onMouseOut={(e) => handleHover(e, false)}
          >
            <span>🔗 Generate attendance QR sessions</span> ➜
          </a>
          ...
          <a
            href="/teacher/dashboard/fraud-alerts"
            style={optionStyle}
            onMouseOver={(e) => handleHover(e, true)}
            onMouseOut={(e) => handleHover(e, false)}
          >
            <span>🚨 Check suspicious (fraud) attempts</span> ➜
          </a>
        </div>
